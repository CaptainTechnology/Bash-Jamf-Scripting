...
# Client-side Log
scriptLog="/var/log/com.anees.log"
...
reverseDomainNameNotation="com.anees"
...
declare -A preferenceConfiguration=(
    # Logging and Timing
    ["scriptLog"]="string|/var/log/com.anees.log"
...
function displayReminderDialog() {
    ...
    dialogArgs=(
        ...
        --overlayicon none # Removes the small badge overlay
        --infobox "${infobox}"
        --button1text "${button1text}"
        --messagefont "size=14"
        --quitkey "k"
